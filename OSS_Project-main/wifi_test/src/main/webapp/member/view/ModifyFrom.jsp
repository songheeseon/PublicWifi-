...
<body onload="init()">
		...
		<br><br>
		<b style="margin-left: 840px;"><font size="6" color="gray">회원정보 수정</font></b>
		<br><br><br>
		...
		<form method="post" action="/member/pro/ModifyPro.jsp" 
			...
			<input type="button" value="취소"  class="grid--cell s-btn s-btn__primary" onclick="location.href='makers.jsp'">
        	<input type="submit" value="수정"  class="grid--cell s-btn z-btn__primary" onclick="location.href='LoginForm.jsp'"/>
			</div>
